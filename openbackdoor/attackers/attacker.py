...
class Attacker(object):
    ...
    def attack(self, victim: Victim, data: List, config: Optional[dict] = None, defender: Optional[Defender] = None):
        ...
        # Post-training defense: clean model weights after training
        if defender is not None and defender.pre is False:
            logger.info(f'{defender.name} defender cleaning model weights')
            defender.correct(poison_data=poison_dataset['train'], model=backdoored_model)
